...
// Drop the official campus photograph at this path (see the README in the
// same folder for specs) and it replaces the placeholder automatically —
// no code changes required.
const HERO_IMAGE_SRC = "/images/hero/campus.jpg";
