      ...
      >
        ...
        <div className="mx-auto flex h-[72px] w-full max-w-[1240px] items-center justify-between gap-4 px-5 sm:px-8 lg:px-10">
            ...
            {primaryNav.map((item) => {
              ...
              return (
                <Link
                  ...
                  href={item.href}
                  className={cn(
                    "focus-ring relative rounded-sm px-3 py-2 text-[13px] font-medium text-slate-600 transition-colors hover:text-navy-950",
          ...
          <button
            ...
            className="focus-ring -mr-2 flex h-10 w-10 shrink-0 items-center justify-center rounded-md text-navy-950 lg:hidden"
